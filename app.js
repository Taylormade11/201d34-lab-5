...
function multiply(a, b) {
  var multiplied = a * b;
  return([a * b, 'The product of ' + a + ' and ' + b + ' is ' + multiplied + '.']);
}
...
function sumAndMultiply(d, e, f) {
  var threeAdded = (sum(f, sum(d, e)[0])[0]);
  var threeMultiplied = (multiply(f, multiply(d, e)[0])[0]);
  return[threeAdded, threeMultiplied, d + ' and ' + e + ' and ' + f + ' sum to ' + threeAdded + '.', 'The product of ' + d + ' and ' + e + ' and ' + f + ' is ' + threeMultiplied + '.'];
}
